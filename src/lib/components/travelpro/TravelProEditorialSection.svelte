<script lang="ts">
  import type { LatestSection, LatestItem } from '$lib/types';
  ...
  let { latestSection }: TravelProEditorialSectionProps = $props();
      ...
      {#each latestSection.items as item, index (item.id)}
        <div class="product-card" data-item-id={item.id} data-preload-url={optimizedUrls[item.id]}>
          ...
          <div class="product-info">
            ...
            <a href={item.products[0].redirectUrl} class="product-image-link" target="_blank" rel="noopener">
